...
var ApiServiceService = /** @class */ (function () {
    ...
    ApiServiceService.prototype.getBusinesses = function (location) {
    ...
    ApiServiceService.prototype.getReviews = function (id) {
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
            ...
            providers: [_api_service_service__WEBPACK_IMPORTED_MODULE_1__["ApiServiceService"]],
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(apiService) {
        ...
        this.loc = { location: "", radius: 10000, price: 4 };
        this.categories = "";
        this.filters = false;
    ...
    HomeComponent.prototype.getBusinesses = function (location) {
        var _this = this;
        this.apiService.getBusinesses(location).then(function (result) {
            var business = result['businesses'][Math.floor(Math.random() * result['businesses'].length)];
            while (business == _this.curPlace) {
                business = result['businesses'][Math.floor(Math.random() * result['businesses'].length)];
            }
            _this.curPlace = business;
            _this.categories = "";
            for (var i = 0; i < _this.curPlace.categories.length - 1; i++) {
                _this.categories += _this.curPlace.categories[i].title + ", ";
            }
            _this.categories += _this.curPlace.categories[i].title;
            var self = _this;
            var id = _this.curPlace.id;
            _this.apiService.getReviews(id).then(function (result2) {
...
module.exports = __webpack_require__(/*! /Users/Rommel/Desktop/oracleproj/food/src/main.ts */"./src/main.ts");
